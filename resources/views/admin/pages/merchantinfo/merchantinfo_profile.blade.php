...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-12">
        <h1 align="center"><i class="fa fa-user"></i> Profile</h1>
      </div>
    </div>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          {{csrf_field()}}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <a href="{{url('change/password')}}" class="btn btn-info text-white"><i class="fa fa-key"></i> Change Password </a>
                      </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <select disabled class="form-control select2" style="width: 100%;"  id="payment_method" name="payment_method">
                            ...
                            <div class="col-md-6 mfs" style="display: none;">
                              <div class="form-group">
                                ...
                                <select disabled class="form-control select2" style="width: 100%;"  id="wallet_provider_id" name="wallet_provider_id">
                                      <option value="">Please Select</option>
                                      @if(isset($wp))    
                                          @if(count($wp)>0)
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-info" href="{{url('user/edit/profile')}}">
