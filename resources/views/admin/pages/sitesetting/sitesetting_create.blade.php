                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Opening Hour" id="opening_hour" name="opening_hour">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Merchant Signup Email" id="merchant_signup_email_notification" name="merchant_signup_email_notification">
                      </div>
                    </div>
                </div>
